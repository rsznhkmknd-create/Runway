      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="bg-surface rounded-2xl border border-border p-6 shadow-sm">
          <div className="flex items-center gap-2 mb-3">
            ...
            <p className="text-xs font-medium text-text-muted uppercase tracking-wide">Ingresos</p>
          </div>
        ...
        <div className="bg-surface rounded-2xl border border-border p-6 shadow-sm">
          <div className="flex items-center gap-2 mb-3">
            ...
            <p className="text-xs font-medium text-text-muted uppercase tracking-wide">Gastos</p>
          </div>
        ...
        <div className="bg-surface rounded-2xl border border-border p-6 shadow-sm">
          <div className="flex items-center gap-2 mb-3">
            ...
            <p className="text-xs font-medium text-text-muted uppercase tracking-wide">Neto</p>
          </div>
      ...
      <div className="bg-surface rounded-2xl border border-border shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-border flex items-center justify-between gap-4">
          ...
          <div className="relative flex-1 max-w-xs">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 text-sm border border-border rounded-lg bg-surface-2 placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-brand-300"
            />
          </div>
        </div>
        ...
        {filtered.length === 0 ? (
          ...
          <div className="divide-y divide-border">
            {filtered.map((tx) => (
              <div key={tx.id} className="flex items-center gap-4 px-6 py-4 hover:bg-surface-2/50 transition-colors">
